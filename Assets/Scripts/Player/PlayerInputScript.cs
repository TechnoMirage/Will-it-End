...
public partial class @PlayerInputScript: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Sprint"",
                    ""type"": ""Button"",
                    ""id"": ""6707338b-83b5-430f-9515-a300b424e07c"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""72397e74-e6b5-4e91-a429-1f6196e773cb"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Interact"",
                    ""type"": ""Button"",
                    ""id"": ""ea4362a5-1950-4980-b959-32fd8463fc03"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Reload"",
                    ""type"": ""Button"",
                    ""id"": ""42639061-8a12-4a06-b75b-2d2f37bf84e4"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Switch"",
                    ""type"": ""Button"",
                    ""id"": ""f21f07da-3fa8-430f-b9c8-e91eed7cad25"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""f6e9a544-19b4-40d1-a294-385761cf49db"",
                ...
                {
                    ""name"": """",
                    ""id"": ""b5c70678-90cd-4863-8b82-fc5c7caad6e8"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""FPSControllerInputs"",
                ...
                {
                    ""name"": """",
                    ""id"": ""006662d6-3145-4218-9c14-06227bfe1a9f"",
                ...
                {
                    ""name"": """",
                    ""id"": ""a8b2aac5-aab3-4150-8cac-014e0e6f0802"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""FPSControllerInputs"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8a850f0a-2fa6-4329-8ce1-7c437cb6d70d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""84668d66-2217-4dee-b98f-350e46bc456a"",
                    ""path"": ""<Keyboard>/shift"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""FPSControllerInputs"",
                ...
                {
                    ""name"": """",
                    ""id"": ""3698fbf4-69cd-425e-a696-63c34895a7db"",
                ...
                {
                    ""name"": """",
                    ""id"": ""2edab4f2-2e69-407c-9bb4-d0dc93eee642"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""FPSControllerInputs"",
                ...
                {
                    ""name"": """",
                    ""id"": ""f5250436-9ec6-4221-a706-311f01c87795"",
                ...
                {
                    ""name"": ""ScrollWheel"",
                    ""id"": ""4a522131-8d86-4fa8-aa8a-3cdb57a67ab3"",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""7655e0bf-c6eb-4518-83a8-ad5f1aaf319f"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""b615af87-206f-43ae-be8d-fbd05a61fdb8"",
    ...
    ""controlSchemes"": [
        ...
        m_FPSController_Shoot = m_FPSController.FindAction("Shoot", throwIfNotFound: true);
        m_FPSController_Throw = m_FPSController.FindAction("Throw", throwIfNotFound: true);
        ...
        m_FPSController_Switch = m_FPSController.FindAction("Switch", throwIfNotFound: true);
        m_FPSController_Inventory = m_FPSController.FindAction("Inventory", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_FPSController_Shoot;
    private readonly InputAction m_FPSController_Throw;
    ...
    private readonly InputAction m_FPSController_Switch;
    private readonly InputAction m_FPSController_Inventory;
    public struct FPSControllerActions
    {
        private @PlayerInputScript m_Wrapper;
        public FPSControllerActions(@PlayerInputScript wrapper) { m_Wrapper = wrapper; }
        public InputAction @Move => m_Wrapper.m_FPSController_Move;
        public InputAction @Look => m_Wrapper.m_FPSController_Look;
        public InputAction @Shoot => m_Wrapper.m_FPSController_Shoot;
        public InputAction @Throw => m_Wrapper.m_FPSController_Throw;
        ...
        public InputAction @Switch => m_Wrapper.m_FPSController_Switch;
        public InputAction @Inventory => m_Wrapper.m_FPSController_Inventory;
